...
def get_args_parser():
    ...
    parser.add_argument('--swin_pretrain_path', type=str, default='.')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('GroupPose training and evaluation script', parents=[get_args_parser()])
